...
const STATUS_STYLES = {
  production: { key: "statusProduction", className: "bg-emerald-500/10 text-emerald-400 border-emerald-500/20" },
  active: { key: "statusActive", className: "bg-accent-2/10 text-accent-2 border-accent-2/20" },
} as const;
