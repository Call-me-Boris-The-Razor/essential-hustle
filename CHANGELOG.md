...
### Fixed
- **Proxy file naming** — reverted `src/middleware.ts` back to `src/proxy.ts` for Next.js 16 convention. PR #176 incorrectly renamed it based on Next.js 14/15 docs (#186)
